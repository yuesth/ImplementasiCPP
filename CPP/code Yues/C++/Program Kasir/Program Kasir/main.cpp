...
int main(){
    ...
    struct pembelian{
        ...
        int kode_barang;
        string nama_barang[6]={"ASUS INTEL CORE i7","SPEAKER WIRELESS SONY","KEYBOARD BUFFTECH RGB27","MOUSE A7X WIRELESS","WEBCAM ANTITHEFT","LAPTOP ROG"};
        long harga_satuan[6]={1000000,800000,500000,300000,100000,14000000};
        long uang_anda;
        long kembalian;
    };
